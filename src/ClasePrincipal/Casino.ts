import * as rs from 'readline-sync';                             // Módulo para manejar la entrada/salida por consola
import { leerSaldo, guardarSaldo } from "../utils/ArchivoTxt";   // Funciones para manejar el guardado y carga del saldo

// Importación de los diferentes juegos disponibles
import { Ruleta } from "../Juegos/Ruleta/ruleta";                                         // Importa la clase Ruleta
import { Tragamonedas } from "../Juegos/Tragamonedas/Clases/AbsTragamonedas";             // Importa la clase abstracta Tragamonedas
import { TragamonedasBar } from "../Juegos/Tragamonedas/Clases/TragamonedasBar";          // Importa la clase Tragamonedas de Bar
import { TragamonedasFrutas } from "../Juegos/Tragamonedas/Clases/TragamonedasFrutas";    // Importa la clase Tragamonedas de Frutas
import { mayorMenor } from "../Juegos/mayorMenor/mayorMenor";                             // Importa la clase Mayor o Menor

// Clase principal del Casino que implementa el patrón Singleton. Gestiona el saldo del jugador y los juegos disponibles
export class Casino {
